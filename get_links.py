...
# DRIVER_PATH = "/home/jeremy/Desktop/scraper/chromedriver"
#
...
# search_box.send_keys('Dogs' + Keys.ENTER)
...
def fetch_image_urls(query: str, max_links_to_fetch: int, wd: webdriver, sleep_between_interactions: float = 1):
    def scroll_to_end(wd2):
        wd2.execute_script("window.scrollTo(0, document.body.scrollHeight);")
